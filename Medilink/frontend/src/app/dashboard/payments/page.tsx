...
const PAYMENTS: Payment[] = [
  {
    id: "p1", invoiceNumber: "INV-2026-0148", date: "Jul 10, 2026", status: "pending",
    category: "Surgery", emoji: "🏥", grad: "from-[#e8d5f0] to-[#d5e8f5]",
    method: { en: "Thawani Pay", ar: "ثواني Pay" }, amount: 450.000, currency: "OMR",
    en: { title: "Surgery Deposit", provider: "Royal Care Clinic", description: "Advance deposit for scheduled minor surgery on Jul 14, 2026." },
    ar: { title: "عربون عملية جراحية", provider: "عيادة رويال كير", description: "دفعة مقدمة لعملية جراحية بسيطة مجدولة بتاريخ ١٤ يوليو ٢٠٢٦." },
  },
  {
    id: "p2", invoiceNumber: "INV-2026-0147", date: "Jul 5, 2026", status: "pending",
    category: "Lab Test", emoji: "🧪", grad: "from-[#d5e8f5] to-[#ede0f8]",
    method: { en: "Card", ar: "بطاقة" }, amount: 18.000, currency: "OMR",
    en: { title: "Lab Test — CBC & Lipid Panel", provider: "Al Shifa Diagnostics", description: "Complete blood count and lipid panel, sample collection at clinic." },
    ar: { title: "تحليل CBC وصورة الدهون", provider: "مختبرات الشفاء", description: "صورة دم كاملة وتحليل الدهون، سحب العينة في العيادة." },
  },
  {
    id: "p3", invoiceNumber: "INV-2026-0142", date: "Jun 20, 2026", status: "paid",
    category: "Consultation", emoji: "🩺", grad: "from-[#e8d5f0] to-[#fde68a]",
    method: { en: "Thawani Pay", ar: "ثواني Pay" }, amount: 25.000, currency: "OMR",
    en: { title: "General Consultation", provider: "Dr. Aisha Al Harthy", description: "In-clinic consultation for throat infection, follow-up prescribed." },
    ar: { title: "استشارة عامة", provider: "د. عائشة الحارثي", description: "استشارة في العيادة لالتهاب الحلق، تم صرف وصفة للمتابعة." },
  },
  {
    id: "p4", invoiceNumber: "INV-2026-0141", date: "Jun 20, 2026", status: "paid",
    category: "Pharmacy", emoji: "💊", grad: "from-[#d1fae5] to-[#e8d5f0]",
    method: { en: "Card", ar: "بطاقة" }, amount: 12.500, currency: "OMR",
    en: { title: "Antibiotic Course", provider: "MediLink Pharmacy", description: "Amoxicillin 500mg, 7-day course as prescribed." },
    ar: { title: "دورة مضادات حيوية", provider: "صيدلية ميدلينك", description: "أموكسيسيلين ٥٠٠ ملغ، دورة ٧ أيام حسب الوصفة." },
  },
  {
    id: "p5", invoiceNumber: "INV-2026-0138", date: "Jun 10, 2026", status: "paid",
    category: "Imaging", emoji: "🩻", grad: "from-[#d5e8f5] to-[#d1fae5]",
    method: { en: "Cash at clinic", ar: "نقدًا في العيادة" }, amount: 35.000, currency: "OMR",
    en: { title: "Chest X-Ray", provider: "Sunrise Diagnostics", description: "Chest X-ray imaging, single view, reviewed by radiologist." },
    ar: { title: "أشعة الصدر", provider: "مختبرات الشروق", description: "تصوير أشعة للصدر، منظر واحد، تمت مراجعته من قبل أخصائي الأشعة." },
  },
  {
    id: "p6", invoiceNumber: "INV-2026-0130", date: "May 28, 2026", status: "paid",
    category: "Consultation", emoji: "🩺", grad: "from-[#e8d5f0] to-[#d5e8f5]",
    method: { en: "Card", ar: "بطاقة" }, amount: 20.000, currency: "OMR",
    en: { title: "Follow-up Consultation", provider: "Dr. Omar Al Balushi", description: "Follow-up visit to review lab results and treatment progress." },
    ar: { title: "استشارة متابعة", provider: "د. عمر البلوشي", description: "زيارة متابعة لمراجعة نتائج التحاليل وسير العلاج." },
  },
  {
    id: "p7", invoiceNumber: "INV-2026-0121", date: "May 15, 2026", status: "paid",
    category: "Pharmacy", emoji: "💊", grad: "from-[#fde68a] to-[#d5e8f5]",
    method: { en: "Thawani Pay", ar: "ثواني Pay" }, amount: 8.750, currency: "OMR",
    en: { title: "Vitamin D Supplement", provider: "MediLink Pharmacy", description: "Vitamin D3 5000 IU, 3-month supply." },
    ar: { title: "مكمل فيتامين د", provider: "صيدلية ميدلينك", description: "فيتامين د٣ ٥٠٠٠ وحدة، لمدة ٣ أشهر." },
  },
  {
    id: "p8", invoiceNumber: "INV-2026-0110", date: "May 2, 2026", status: "refunded",
    category: "Physiotherapy", emoji: "🧘", grad: "from-[#d5e8f5] to-[#ede0f8]",
    method: { en: "Card", ar: "بطاقة" }, amount: 15.000, currency: "OMR",
    en: { title: "Physiotherapy Session", provider: "Royal Care Clinic", description: "Session cancelled by provider; amount refunded in full." },
    ar: { title: "جلسة علاج طبيعي", provider: "عيادة رويال كير", description: "تم إلغاء الجلسة من قبل مزود الخدمة؛ تم استرداد كامل المبلغ." },
  },
  {
    id: "p9", invoiceNumber: "INV-2026-0098", date: "Apr 25, 2026", status: "failed",
    category: "Dental", emoji: "🦷", grad: "from-[#ede0f8] to-[#fde68a]",
    method: { en: "Card", ar: "بطاقة" }, amount: 30.000, currency: "OMR",
    en: { title: "Dental Cleaning", provider: "Smile Dental Centre", description: "Card payment declined by bank; appointment rescheduled." },
    ar: { title: "تنظيف الأسنان", provider: "مركز سمايل لطب الأسنان", description: "تم رفض الدفع من قبل البنك؛ أُعيدت جدولة الموعد." },
  },
];
    ...
    <div dir={ar ? "rtl" : "ltr"} style={{ width: 640, background: "#ffffff", color: "#2E1A47", padding: 40, fontFamily: "sans-serif" }}>
      ...
      <div className={`flex items-center justify-between py-5 ${ar ? "flex-row-reverse" : ""}`}>
        <div className={ar ? "text-right" : ""}>
          ...
          <p style={{ fontWeight: 700, fontSize: 14, marginTop: 4 }}>{ar ? "فارتيكا بانديا" : "Vartika Pandey"}</p>
          <p style={{ fontSize: 12, color: "#2E1A4799" }}>vartika.pandey@inzint.com</p>
        </div>
        <div className={ar ? "text-left" : "text-right"}>
