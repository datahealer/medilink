...
export const ARTICLES: Article[] = [
  {
    ...
    ar: {
      tag: "كورونا",
      title: "12 خرافة وحقيقة عن كورونا يجب أن تعرفها",
  ...
  },
  {
    ...
    ar: {
      ...
      body: [
        ...
        "في العشرينات: فحوصات سنوية شاملة، فحص عنق الرحم بدءاً من سن 21، ونقاش أساسي حول الصحة الإنجابية ووسائل منع الحمل إن لزم.",
  ...
  },
  {
    ...
    ar: {
      ...
      body: [
        ...
        "اتصلي بطبيب فوراً إذا كان طفلك أقل من 3 أشهر ولديه أي حمى، أو استمرت الحمى أكثر من 3 أيام، أو كان نعساً بشكل غير معتاد أو يصعب إيقاظه، أو ظهر لديه طفح جلدي أو تيبس في الرقبة أو صعوبة في التنفس.",
  ...
  },
  {
    ...
    ar: {
      tag: "لياقة",
      title: "تمارين إطالة لمدة 5 دقائق لظهر يجلس طويلاً",
      ...
      body: [
        ...
        "ابدأ بلفة للعمود الفقري وأنت جالس: اجلس منتصباً، ضع يدك على الركبة المقابلة، ولفّ جذعك بلطف مع الثبات 15-20 ثانية لكل جانب.",
        ...
        "اضبط تذكيراً للوقوف والحركة كل 45-60 دقيقة؛ الانتظام أهم من الشدة لتعويض آثار الجلوس الطويل."],
    },
  },
  {
    ...
    ar: {
      ...
      body: [
        ...
        "المشي لمدة 20-30 دقيقة بعد الوجبات من أكثر الطرق فعالية وسهولة لخفض سكر الدم بعد الأكل — حتى النشاط الخفيف يُحدث فرقاً ملموساً.",
  ...
  },
  {
    ...
    ar: {
      ...
      body: [
        ...
        "ضعي واقي شمس واسع الطيف بعامل حماية 30 أو أكثر كل صباح كجزء من روتينك، وليس فقط في أيام الشاطئ، وأعيدي وضعه كل ساعتين إذا كنتِ في الخارج لفترات طويلة.",
        "بين الساعة 11 صباحاً و3 عصراً، تكون الأشعة فوق البنفسجية في أشد قوتها — جدولة المهام أو الرياضة خارج هذا الوقت يقلل بشكل ملموس من الضرر التراكمي.",
