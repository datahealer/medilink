...
export const SCREENS: ScreenEntry[] = [
  ...
  { id: "check-in", n: 32, title: "Check-in", flow: "09 Appointments Module", pdfPage: 25, route: "/appointments/mock-appt-1/check-in", built: true, batch: 3 },
  ...
  // 10 — AI Features
  { id: "ai-symptom", n: 34, title: "AI Symptom Checker", flow: "10 AI Features", pdfPage: 26, route: "/ai/assistant", built: true, batch: 5 },
  { id: "ai-recommendations", n: 35, title: "AI Recommendations", flow: "10 AI Features", pdfPage: 27, route: "/ai/recommendations", built: true, batch: 5 },
  { id: "ai-insights", n: 36, title: "AI Insights & Risk", flow: "10 AI Features", pdfPage: 27, route: "/ai/insights", built: true, batch: 5 },

  // 11 — Document Vault
  { id: "vault", n: 37, title: "Medical Documents (Me Vault)", flow: "11 Document Vault", pdfPage: 28, route: "/records", built: true, batch: 4 },
  { id: "upload-documents", n: 38, title: "Upload Documents", flow: "11 Document Vault", pdfPage: 28, route: "/records/upload", built: true, batch: 4 },
  { id: "document-preview", n: 39, title: "Document Preview", flow: "11 Document Vault", pdfPage: 29, route: "/records/document/blood-test", built: true, batch: 4 },

  // 12 — Lab Results
  { id: "lab-reports", n: 40, title: "Lab Reports", flow: "12 Lab Results", pdfPage: 29, route: "/records/labs", built: true, batch: 4 },
  { id: "lab-detail", n: 41, title: "Result Trends & Detail", flow: "12 Lab Results", pdfPage: 30, route: "/records/labs/lipid", built: true, batch: 4 },

  // 13 — Prescriptions
  { id: "prescriptions", n: 42, title: "Active Prescriptions", flow: "13 Prescriptions", pdfPage: 30, route: "/records/prescriptions", built: true, batch: 4 },
  { id: "medication-details", n: 43, title: "Medication Details", flow: "13 Prescriptions", pdfPage: 31, route: "/records/prescriptions/salbutamol", built: true, batch: 4 },
  ...
  // 15 — Ratings & Reviews
  { id: "doctor-rating", n: 47, title: "Doctor Rating", flow: "15 Ratings & Reviews", pdfPage: 33, route: "/rate/mock-appt-1", built: true, batch: 5 },
  { id: "review-submission", n: 48, title: "Review Submission", flow: "15 Ratings & Reviews", pdfPage: 33, route: "/rate/success", built: true, batch: 5 },
