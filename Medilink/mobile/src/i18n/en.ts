...
export const en = {
  ...
  aiAssistant: {
    ...
    title: "Me Assistant",
    greeting: "Hi {name} 👋 I'm Me, your MediLink care assistant. Tell me what you're feeling and I'll help you find the right care.",
    sampleUser: "I've had chest tightness and shortness of breath since morning.",
    followUp: "Thanks. A few quick questions — does it worsen with activity?",
    quickYes: "Yes",
    quickNo: "No",
  ...
  aiRecommend: {
    ...
    reasoning: "Chest tightness + breathlessness — we suggest seeing a Cardiologist today.",
  ...
  aiInsights: {
    ...
    progressNote: "Good progress. Blood pressure improved 8% since your last visit.",
